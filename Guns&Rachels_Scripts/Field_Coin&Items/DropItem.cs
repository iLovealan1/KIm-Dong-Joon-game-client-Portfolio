...
public class DropItem : MonoBehaviour
{
    ...
    // when player gets Weapon
    public void GetWeaponItem()
    {
        Destroy(this.gameObject);
    }

    // when player gets Relic
    ...
    public void DOMoveToUIAndDestory(int rNum = 0)
    {
        ...
        this.targetPoint = new Vector3(UITargeTrans.localPosition.x, UITargeTrans.localPosition.y,this.transform.localPosition.z);
