...
- - -
:red_circle: A*알고리즘을 활용한 절차적 랜덤 맵 생성 스크립트 제작.[📚:설명보기](#astar_random_map_generator) [📜:스크립트전체보기](https://github.com/iLovealan1/KIm-Dong-Joon-game-client-Portfolio/tree/main/Scripts/Astar_MapGenerator)<br>
:red_circle: Main to Director 스크립트를 이용한 씬 전환 및 스테이지 전환.[📚:설명보기](#main_directors) [📜:스크립트전체보기](https://github.com/iLovealan1/KIm-Dong-Joon-game-client-Portfolio/tree/main/Scripts/Main%26Director)<br>
:red_circle: 스테이지 루프 로직 및 씬전환에 필요한 데이터 연동 구조 기획 및 제작.[📚:설명보기](#main_directors)<br>
:red_circle: 유니티 타일맵 컴포넌트를 사용한 마을 & 던전 레벨 디자인.<br>
* * *
:green_circle: 스탯인벤토리 제작.[📚:설명보기](#statinventory) [📜:스크립트전체보기](https://github.com/iLovealan1/KIm-Dong-Joon-game-client-Portfolio/tree/main/Scripts/Main%26Director)<br>
:green_circle: 상자 출현 아이템 생성 구조 설계 및 스크립트 제작.[📚:설명보기](#chest_itemGenerator) [📜:스크립트전체보기](https://github.com/iLovealan1/KIm-Dong-Joon-game-client-Portfolio/tree/main/Scripts/Chest%26ItemGenerator)<br> 
:green_circle: 오브젝트 풀링을 이용한 필드 출현 Coin 스크립트 및 필드 획득 아이템 제작.[📚:설명보기](#field_items) [📜:스크립트전체보기](https://github.com/iLovealan1/KIm-Dong-Joon-game-client-Portfolio/tree/main/Scripts/Field_Coin%26Items)<br>
:green_circle: UniRx 플러그인을 활용한 필드 아이템 터치 조작 & 애니메이션.[📚:설명보기](#uniRx_touch_control) [📜:스크립트전체보기](https://github.com/iLovealan1/KIm-Dong-Joon-game-client-Portfolio/tree/main/Scripts/Chest%26ItemGenerator)<br>
* * *
:large_blue_circle: **제작한 UGUI 리스트 (구성,기획,스크립트 제작)**<br>
 &nbsp;&nbsp;&nbsp;&nbsp; :heavy_check_mark: 일시정지화면 UI [📚:설명보기](#pauseui) [📜:스크립트전체보기](https://github.com/iLovealan1/KIm-Dong-Joon-game-client-Portfolio/tree/main/Scripts/UGUI/Pause_UI)<br>
 &nbsp;&nbsp;&nbsp;&nbsp; :heavy_check_mark: 게임 오버 UI [📚:설명보기](#gameoverui) [📜:스크립트전체보기](https://github.com/iLovealan1/KIm-Dong-Joon-game-client-Portfolio/tree/main/Scripts/UGUI/GameOver_UI)<br>
 &nbsp;&nbsp;&nbsp;&nbsp; :heavy_check_mark: 다이얼로그 UI [📚:설명보기](#dialogueui) [📜:스크립트전체보기](https://github.com/iLovealan1/KIm-Dong-Joon-game-client-Portfolio/tree/main/Scripts/UGUI/Dialog_UI)<br>
 &nbsp;&nbsp;&nbsp;&nbsp; :heavy_check_mark: 아이템 필드 팝업 UI [📚:설명보기](#item_field_popup_ui) [📜:스크립트전체보기](https://github.com/iLovealan1/KIm-Dong-Joon-game-client-Portfolio/tree/main/Scripts/UGUI/Item_FieldPopup_UI)<br>
 &nbsp;&nbsp;&nbsp;&nbsp; :heavy_check_mark: NPC 월드 팝업 UI [📚:설명보기](#chest_itemgenerator) [📜:스크립트전체보기](https://github.com/iLovealan1/KIm-Dong-Joon-game-client-Portfolio/tree/main/Scripts/Chest%26ItemGenerator)<br>
 &nbsp;&nbsp;&nbsp;&nbsp; :heavy_check_mark: 가이드 애로우 UI [📚:설명보기](#guidearrowui) [📜:스크립트전체보기](https://github.com/iLovealan1/KIm-Dong-Joon-game-client-Portfolio/tree/main/Scripts/UGUI/Guide_Arrow_UI)<br>
 &nbsp;&nbsp;&nbsp;&nbsp; :heavy_check_mark: 안내멘트 팝업 UI [📚:설명보기](#announceui) [📜:스크립트전체보기](https://github.com/iLovealan1/KIm-Dong-Joon-game-client-Portfolio/tree/main/Scripts/UGUI/Announce_UI)<br>
 &nbsp;&nbsp;&nbsp;&nbsp; :heavy_check_mark: 미니맵 UI [📚:설명보기](#minimap) [📜:스크립트전체보기](https://github.com/iLovealan1/KIm-Dong-Joon-game-client-Portfolio/tree/main/Scripts/UGUI/MiniMap_UI)<br>
:large_blue_circle: **싱글톤 패턴 스크립트 제작 리스트(협업용 InfoManager, DataManager Partial Scripts)**.[📜:스크립트전체보기](https://github.com/iLovealan1/KIm-Dong-Joon-game-client-Portfolio/tree/main/Scripts/SingleTonManager)<br>
 ...
 * * *
:yellow_circle: 메인 카메라 로직 제작 (User Following Cam 및 Hit Effect 연출). [📚:설명보기](#maincam) [📜:스크립트전체보기](https://github.com/iLovealan1/KIm-Dong-Joon-game-client-Portfolio/tree/main/Scripts/MainCam)<br>
:yellow_circle: 디파짓 시스템 핵심 기능 제작(Deposit(), MakeDipositTupleList() 메서드 참조).[📜:스크립트전체보기](https://github.com/iLovealan1/KIm-Dong-Joon-game-client-Portfolio/blob/main/Scripts/SingleTonManager/InfoManager_PossessionAmount.cs)<br>
...
:red_circle: A*알고리즘을 응용한 랜덤맵 생성기<br>[📜:스크립트전체보기](https://github.com/iLovealan1/KIm-Dong-Joon-game-client-Portfolio/tree/main/Scripts/Astar_MapGenerator)
===
...
* * *
### main_directors
:red_circle: Main to Director 스크립트를 이용한 씬 전환 및 스테이지 전환<br>[📜:스크립트전체보기](https://github.com/iLovealan1/KIm-Dong-Joon-game-client-Portfolio/tree/main/Scripts/Main%26Director)
===
...
* * *
### statinventory
:green_circle:스탯인벤토리<br>[📜:스크립트전체보기](https://github.com/iLovealan1/KIm-Dong-Joon-game-client-Portfolio/tree/main/Scripts/Main%26Director)
===
...
* * *
### chest_itemgenerator
:green_circle:상자 생성 및 아이템 생성<br>[📜:스크립트전체보기](https://github.com/iLovealan1/KIm-Dong-Joon-game-client-Portfolio/tree/main/Scripts/Chest%26ItemGenerator)
===
...
:green_circle:오브젝트 풀링을 이용한 필드 출현 Coin & 아이템 스크립트<br>[📜:스크립트전체보기](https://github.com/iLovealan1/KIm-Dong-Joon-game-client-Portfolio/tree/main/Scripts/Field_Coin%26Items)
===
### field_items
...
* * *
### uniRx_touch_control
:green_circle:UniRx 플러그인을 활용한 필드 아이템 터치 조작 & DOTween 아이템 획득 연출<br>[📜:스크립트전체보기](https://github.com/iLovealan1/KIm-Dong-Joon-game-client-Portfolio/tree/main/Scripts/Chest%26ItemGenerator)
===
...
* * *
### pauseui  
:large_blue_circle: 일시정지, 크레딧 UI (구성,기획,스크립트 제작)<br>[**📜:스크립트전체보기**](https://github.com/iLovealan1/KIm-Dong-Joon-game-client-Portfolio/tree/main/Scripts/UGUI/Pause_UI)<br>
===
...
* * *
### gameoverui 
:large_blue_circle: 게임오버 화면 UI (구성,기획,스크립트 제작)<br>[**📜:스크립트전체보기**](https://github.com/iLovealan1/KIm-Dong-Joon-game-client-Portfolio/tree/main/Scripts/UGUI/GameOver_UI)<br>
===
...
* * *
### dialogueui 
:large_blue_circle: 다이얼로그 UI (구성,기획,스크립트 제작)<br>[**📜:스크립트전체보기**](https://github.com/iLovealan1/KIm-Dong-Joon-game-client-Portfolio/tree/main/Scripts/UGUI/Dialog_UI)<br>
===
...
* * *
### item_field_popup_ui 
:large_blue_circle: 필드 아이템 팝업 UI (구성,기획,스크립트 제작)<br>[**📜:스크립트전체보기**](https://github.com/iLovealan1/KIm-Dong-Joon-game-client-Portfolio/tree/main/Scripts/UGUI/Item_FieldPopup_UI)<br>
===
...
* * *
### guidearrowui  
:large_blue_circle: 유저 맵 가이드 화살표 UI (구성,기획,스크립트 제작)<br>[**📜:스크립트전체보기**](https://github.com/iLovealan1/KIm-Dong-Joon-game-client-Portfolio/tree/main/Scripts/UGUI/Guide_Arrow_UI)<br>
===
...
* * *
### announceui 
:large_blue_circle: 유저 안내 문구 팝업 UI (구성,기획,스크립트 제작)<br>[**📜:스크립트전체보기**](https://github.com/iLovealan1/KIm-Dong-Joon-game-client-Portfolio/tree/main/Scripts/UGUI/Announce_UI)<br>
===
...
* * *
### minimap  
:large_blue_circle: 미니맵 UI (구성,기획,스크립트 제작)<br>[**📜:스크립트전체보기**](https://github.com/iLovealan1/KIm-Dong-Joon-game-client-Portfolio/tree/main/Scripts/UGUI/MiniMap_UI)<br>
===
...
* * *
### maincam  
:large_blue_circle: 메인카메라 연출(구성,기획,스크립트 제작)<br>[**📜:스크립트전체보기**](https://github.com/iLovealan1/KIm-Dong-Joon-game-client-Portfolio/tree/main/Scripts/MainCam)<br>
===
